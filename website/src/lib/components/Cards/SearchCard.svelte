			...
			{#if hit.size}
				<div class="p-1">
					<div class="flex justify-between">
						<h3 class="text-rich-black font-medium text-base">Size</h3>
						<h3 class="text-rich-black font-medium text-base">{hit.size}{hit.unit}</h3>
					</div>
				</div>
			{:else}
				<div class="pt-6"/>
						...
						<div class="flex justify-between">
							<h3
								class="flex items-center {x === 0
									...
									: 'text-rich-black font-medium'} text-base capitalize truncate"
							>
								{data.storeName}
								<!-- <button
