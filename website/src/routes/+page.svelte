...
<div class="mx-auto text-center pt-20">
    ...
    <div class="bg-rich-black py-20">
        ...
        <div id="search-bar" class="flex justify-center p-10">
            <input class="p-2 rounded-l-lg w-2/3 border-y border-l-2 border-accent shadow-md bg-gradient-to-b focus:outline-none" placeholder="Search our Products" />
            <a href="#" class="p-2 rounded-r-lg border-y border-r-2 border-accent bg-accent bg-grad shadow-md w-16 flex justify-center"><Magnify color={'white'} width={24} height={24} /></a>
        </div>
    ...
    <!-- FAQ -->
    <div class="bg-primary py-10 flex justify-center">
        <div class="w-1/2">
    ...
    <footer class="bg-primary pt-5 pb-20 flex gap-5 justify-center">
