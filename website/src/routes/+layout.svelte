...
<!-- Slide Menu -->
<div
	class="fixed left-0 top-0 w-64 h-screen transition-transform z-30"
	style="transform: translateX({sideOpen ? '0%' : '-100%'});"
>
	<div class="h-full bg-background">
		<h2 class="text-2xl text-black py-4 w-full text-center">Account stuff???? Or remove?</h2>
		<h2 class="text-2xl text-black py-4 w-full text-center">Maybe use for cart!</h2>
	</div>
</div>
...
<div class="fixed left-0 top-0 w-screen z-10 p-4 flex space-x-4 bg-primary shadow-lg">
	...
	<button class="rounded-full bg-white w-12 h-12 flex justify-center items-center">
